...
The main purpose of CloudCompare on Puhti-rhel7 is to serve as a tool for visualizing point cloud data.

## Availability

The following versions of CloudCompare are available in **Puhti-rhel7**:

- Cloudcompare 2.10.3

## Usage

### Puhti-rhel7 web interface

The easiest option for using CloudCompare is to open it in [Puhti-rhel7 web interface as Desktop app](../computing/webinterface/desktop.md).
...
Alternatively, especially if you want to use CloudCompare together with some other Graphical User Interface (GUI) tool or want to use data from Allas, CloudCompare can be started in Puhti-rhel7 web interface with remote desktop:
