...
your local web browser. You can use commands [a-flip](../../docs/data/Allas/using_allas/a_commands.md#a-flip) or [a-publish](../../docs/data/Allas/using_allas/a_commands.md#a-publish) to do the copying:
