...
*   Version 1.7  is available in Puhti-rhel7 and in Chipster


### Usage

To use VirusDetect in Puhti-rhel7 you first need to load _biokit_ and _virusdetect_ modules.
```text
module load biokit
...
Bowtie. In Puhti-rhel7 the Silva database is available in path:
...
host organism. CSC is not maintaining BWA indexes in Puhti-rhel7 environment,
...
```
More information about running batch jobs in Puhti-rhel7 can be found from
...
As many of the output files are in html format, it may be difficult to study them in Puhti-rhel7.
