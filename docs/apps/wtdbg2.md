...
In Puhti-rhel7, the wtdbg2 is activated by loading the biokit environment.
...
In the case of any large ( more than 10 Mb) genomes,  wtdbg2 assembly process can take several hours or days. In Puhti-rhel7, this large tasks shoud always be executed as batch jobs.
