...
!!! info "News"
  **22.7.2025** R version 4.5.1 is now available in `r-env` in Puhti and Mahti and is set as the default version. The new version will be available in RStudio in the Puhti and Mahti web interfaces shortly.  
