...
__SAGA GIS__ is available in Puhti-rhel7 in [r-env module  with different versions](r-env-for-gis.md).
...
For more information on running R jobs on Puhti-rhel7, please see the [`r-env` documentation](r-env.md).
