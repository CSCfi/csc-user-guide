...
<style> .pkg-table table { font-size: 0.78rem; } .pkg-table td, .pkg-table th { padding: 2px 8px; } .pkg-table tr:nth-child(even) { background: var(--md-default-fg-color--lightest); } </style>
