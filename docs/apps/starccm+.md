...
Several versions of Star-CCM+ are available on the [Puhti](../computing/system-puhti) server for analysis runs. Use command
...
Copy the file and modify it for your own use. Further instructions are given in the file.  How to submit a batch job on CSC's servers, see the user guide *CSCDocs*, page [Getting started](../computing/running/getting-started).
