...
Example batch job script for Puhti-rhel8 using 8 cores. (We are using 8 cores since our example uses nchains=4, nruns=2, so 4*2=8.)
...
```
To submit the job in Puhti-rhel8:
```text
sbatch mb_batch 
```
