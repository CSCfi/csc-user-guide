...
It is also possible to access QGIS functionalities from Python without an graphical user interface with the [PyQGIS library](https://docs.qgis.org/testing/en/docs/pyqgis_developer_cookbook/). Use `python` for accessing PyQGIS libraries.
...
```QGIS.org, 2026. QGIS Geographic Information System. QGIS Association. http://www.qgis.org```
