...
Rclone should not be be used to copy or rename objectd in Allas. Rclone provides commands for these operations but they don't work correctly for over 5 GB files. [Linkki](../vika/)
