...
> **WARNING:** If you use rclone and your data upload process gets interrupted, please remove the partially uploaded object before restarting the upload process. Otherwise rclone has sometimes reports a successful data upload even though not all data has been copied to Allas.
