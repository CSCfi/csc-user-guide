...
[Services for Sensitive Data](../sensitive-data/index.md) ( [SD Connect](../sensitive-data/sd_connect.md) and [Federated EGA](../sensitive-data/federatedega.md)))
