...
|  [**Project directories in CSC supercomputers**](../../computing/disk.md) | disk areas for processing data                                 | 50GB, 1-10 TB short term (more on request)                    | file system                                                            | project group                       |             Unused files in Puhti scratch will be deleted after 90 or 180 days depending on quota ([see policy](../../computing/usage-policy.md#disk-cleaning))                                                           | CSC                               |
