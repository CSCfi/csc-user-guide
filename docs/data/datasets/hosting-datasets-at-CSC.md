...
|  [**Project directories in Puhti supercomputer**](../../../computing/disk/) | disk areas for processing data                                 | 50GB, 1 TB short term (more on request)                    | file system                                                            | project group                       |                                                                             | CSC                               |
...
| [**Kaivos relational database service**](../kaivos/index.md) | data for applications utilizing relational databases           | up to tens of GBs                                          | MariaDB database                                                       | project group                       |                                                                           | CSC                               |
