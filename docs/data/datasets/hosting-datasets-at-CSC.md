...
|  [**Project directories in Roihu**](../../computing/disk.md) | disk areas for processing data                                 | 50GB - 200 GB short term (more on request)                    | file system                                                            | project group                       |             Unused files in Roihu scratch will be deleted after 90 or 180 days depending on quota ([see policy](../../computing/usage-policy.md#disk-cleaning))                                                           | CSC                               |
