...
|  [**Project directories in CSC supercomputers**](../../computing/disk.md) | disk areas for processing data                                 | 50GB, 1 TB short term (more on request)                    | file system                                                            | project group                       |             Storage time in scratch directories is limited to  6 months                                                            | CSC                               |
...
| [**Federated EGA**](../sensitive-data/federatedega.md) | A service for storing and publishing human genetic and phenotypic data consented for research | Case dependent | Command line interface for data upload. Web interface for management | Access based on contract | Not free-of-charge. Contract needed between home organization and CSC. Controlled data access for users through the SD services of CSC. | CSC 
