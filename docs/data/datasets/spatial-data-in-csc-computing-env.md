...
These datasets are public, so anybody can download them, also from their own computer or other services, Roihu access is not needed.
...
Please acknowledge the data producer according to the license terms as well as CSC and Geoportti in your publications, it is important for project continuation and funding reports. If you use data provided in Allas, please also acknowledge the person sharing the data.
