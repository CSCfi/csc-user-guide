...
<iframe width="280" height="155" src="https://www.youtube.com/embed/m5BK6UdWbNg" title="YouTube video player" frameborder="0" allow Research data
    ...
    [Start here: Accessing Sensitive Data services :material-arrow-right  
    [Store with SD Connect :material-arrow-right:](sd  [Analyse with SD Desktop :material-arrowright:  
    [Publish with Federated EGA :material-arrow-right:](federatedegaith SD Apply :material-arrow-right:
- #### Secondary use of health and social data

    ---

    [Start here with **Findata permit** :material-arrow-right:](findata-permite with **Public Register permit** :material-arrow-right:](single-register-permitesktop for secondary use :material-arrow-right:](sd-desktop-auditedary use data :material-arrow-right:](single-register-submission.md)
