...
**Disk quota**:  storage space available to CSC's services users. SD Connect has a default quota of 10 TB. You can apply for more storage space by writing at servicedesk@csc.fi. 
...
**Data Transfer outside the European Econimic Area**: Transferring personal data out of the EEA requires an appropriate basis for the transfer and compliance with the other requirements imposed by data protection legislation. 
