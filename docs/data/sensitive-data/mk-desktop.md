...
Unfortunately, we are not yet providing a virtual Desktop with Windows or Linux Ubuntu operating systems, or with GPUs. However, we are working on it, and you can find more information on the future developments of the services on our webpage.
...
Find solutions to common problems in the [Troubleshooting](https://docs.csc.fi/data/sensitive-data/sd_desktop/#troubleshooting) paragraph under SD Desktop.
