...
You need to know the Share ID of the **recipient** CSC project. The recipient can copy the Share ID from the SD Connect user interface (select correct CSC project, then click **Copy Share ID **next to project number) and provide it to you via email. 
