...
7. Select ***Project 1*** and upload your data: [See upload instructions](./sd-connect-upload.md).
8. Click “**Share**” next to the folder where you uploaded data.
...
Now, all the content in the folder is visible to Project 2 (Team B) and accessible only through SD Desktop. Project 2 members can access and analyse the shared folder content via SD desktop. However, they cannot export or download files, as the project manager manages data exports - and you are the project manager of both projects.
