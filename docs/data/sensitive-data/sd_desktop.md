...
After entering your username and passwrod, you need to  **verify your identity** by entering the verification **code** provided via the mobile application (or Multi factor Authentication). For specific guidance regarding the verification step, check the [Accounts](../../accounts/index.md) paragraph at the beginning of this user guide. For further intruction see the (MFA paragraph)[../../accounts/mfa.md#multi-factor-authentication], under the Account section on the CSC user guide.
