...
Via the SD Connect user interface you can download either the entire bucket contents, folders stored in it or individual files. The user interface automatically decrypts the data during the download process, so the downloaded files are ready to use.
