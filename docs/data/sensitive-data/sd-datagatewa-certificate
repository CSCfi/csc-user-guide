...
If the terminal says that command is not found, contunue with the followng steps: 
...
4. Make sure that the editor view is active by clking in it.

5. Next Then open the Clipboard-dashboard by pressing:
