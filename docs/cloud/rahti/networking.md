...
For more information refer to the OpenShift documentation regarding [route based deployment strategies](https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/building_applications/deployments#route-based-deployment-strategies).
