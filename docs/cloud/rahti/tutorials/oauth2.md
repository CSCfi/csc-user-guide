...
You can find more information about this configuration on the [OAuth2 Proxy website](https://oauth2-proxy.github.io/oauth2-proxy/configuration/integrations/)
