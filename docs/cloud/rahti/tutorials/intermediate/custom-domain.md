!!! warning "Middle level"
    You need a knowledge of OpenShift CLI tool [oc](../../get-started/cli.md) and OpenShift [Routes](../../usage/kubernetes-concepts.md#route) API  
...
See the explanation in the [Networking routes](../../usage/networking.md#routes) page.
