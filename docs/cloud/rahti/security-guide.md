...
There is no plan to change this IP, but it is not possible to give a 100% assurance that an unforeseeable event will never force us to change it. If this IP ever changes, it will be properly announced in advance.
