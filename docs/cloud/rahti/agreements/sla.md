...
* The Kajaani datacenter infrastructure
* The Funet network
* The cPouta service
* CSC's user administration
* CSC Service Desk, for user support

## Support

Support for the services covered by the scope of this SLA are provided through the CSC Service Desk channels and under the CSC Service Desk policies:
...
Website and contact form | https://research.csc.fi/cloud-computing https://research.csc.fi/support
Response time target | Within three working days

### Incident handling

Disruptions to the agreed service functionality or quality are handled according to an appropriate priority based on the impact and urgency of the incident. In this context, the following general priority guidelines apply:
...
Availability is calculated by subtracting the service break time from the ideal availability during service time. This information is obtained from the internal monitoring systems and defined as the Users’ ability to manage their User Applications, and the availability of the User Applications.
...
The User contacts the CSC Service Desk for the case of a possible SLA violation. The case is analyzed internally and, if the violation is confirmed, CSC will inform the User about the reasons for the violation, planned mitigation actions and expected resolution time.
...
* Failures of single container instances are expected behaviour and do not count as downtime.

## Communication, reporting and escalation

### General communication

The following contacts will generally be used for communications related to the service in the scope of this SLA:
...
Service reports regarding availability will be available from the Service Desk by request. The information provided will be limited to service availability and by data security and privacy constraints.
...
Handling personal information in the Rahti service: https://research.csc.fi/rahti

## Additional responsibilities of the Service Provider

Additional responsibilities of the Service Provider:

* Adhere to all applicable operational and security policies and procedures defined in CSC’s Security Policy ([Information security & data protection](sla.md#information-security-and-data-protection)) and to other policy documents referenced therein.
...
* *Response time*: Time spent between the time of a User's support request and the first response from CSC Staff
...
An extended list of term definitions adopted on this document: [FitSM-0: Overview and vocabulary document](https://fitsm.itemo.org/wp-content/uploads/sites/3/2018/05/FitSM-0_Overview_and_vocabulary.pdf)
