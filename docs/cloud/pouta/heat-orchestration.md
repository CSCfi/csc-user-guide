...
!!! note
    You should use "2018-03-02" ("queens") or older as the [Heat template
    version](https://docs.openstack.org/heat/latest/template_guide/hot_spec.html#queens). Features in newer template versions may not be supported. 
...
Here is the example:  
```yaml
heat_template_version: queens # As mentioned above, you can either use the date or the name
