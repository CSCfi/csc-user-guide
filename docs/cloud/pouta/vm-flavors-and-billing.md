...
- **Storage volumes**: The price for standard volumes is 3.6 Cloud BU / TiB-hour, and for capacity volumes it is 1.8 Cloud BU / TiB-hour. Billing is based on the total size of the volume. On the [Volumes](https://pouta.csc.fi/dashboard/project/volumes/) page of your project, you can view all existing volumes. For more information about persistent volumes, see the [persistent volumes documentation](./persistent-volumes.md).
...
Also note that there will be slight adjustment in BU consumption rates of standard and I/O floavors of cPouta from year 2026 as shown in the tables. 
...
Please note that there will be slight adjustment in BU consumption rates of standard and I/O floavors of ePouta from year 2026 as shown in the tables.
