...
* Any certificate provider can be used, like for example use the free certificates provided by the [Let's Encrypt controller](tutorials/custom-domain.md#cloud-native-certificate-management).
