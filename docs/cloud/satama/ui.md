...
* **Labels** tab allows users to organize and categorize images by attaching labels to them. Labels act as metadata and can help teams identify important images, such as those that are approved for production or those that have been tested.
