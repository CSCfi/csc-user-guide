...
![Activate MFA on My.csc.fi](../img/small/mfa1.png)
...
![Read QR Code with Google Authenticator](../img/small/mfa2.png)
...
![Using the MFA Client](../img/small/mfa4.png)

Read the 6-digit code, and fill it into the field in the service dialogue.

![Fill in the 6-digit Code](../img/small/mfa5.png)
