...
1. Does your project handle personal data? Select _Yes_ or _No_. Read more about [handling personal data in your project](docs/accounts/when-your-project-handles-personal-data.md).
