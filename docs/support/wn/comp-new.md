...
On Puhti there is a process to clean (delete) old files in scratch that are not in active use. To ensure the system remains usable we are changing the [cleaning policy](../../computing/usage-policy.md#disk-cleaning)
. The new policy is:
