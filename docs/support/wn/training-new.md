...
## FireWorks workflow tutorial 15.2.2022

A [tutorial on how to use the FireWorks workflow tool](../../computing/running/fireworks.md) in CSC's computing environment has been released. The tutorial explains how to use an external MongoDB on Rahti as a backend database for FireWorks, as well as how to launch workflows running parallel jobs through the batch queue system.
