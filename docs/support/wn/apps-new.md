...
Version 2023.2 of the [Cambridge Structural Database (CSD)](../../apps/csd.md)
software suite has been installed and set as the default module on Puhti.
[See release notes here](https://www.ccdc.cam.ac.uk/solutions/whats-new/).
