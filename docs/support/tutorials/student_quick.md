...
- The student project has access to **a fixed amount of resources** for **a fixed period of time** for [selected CSC services](#available-services). *The quota of services cannot be increased and the end date of the project cannot be extended.*
