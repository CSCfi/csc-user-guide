...
Puhti has a [large selection of scientific computing applications pre-installed](../../apps/index.md),  in particular [R](../../apps/r-env.md) and [Python libraries for data analysis](../../apps/python-data.md).  If you find something missing, don't hesitate to contact our [Service Desk](https://www.csc.fi/contact-info).
...
If you are using R for data analysis, we also support [Parallell batch jobs in R](../../apps/r-env.md#parallel-batch-jobs).
