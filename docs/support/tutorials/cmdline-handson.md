...
Copy the *serial batch script* template from [CSC's R-env page](../../apps/r-env.md#basic-r-batch-job-script)
...
use the [RStudio app](https://docs.csc.fi/computing/webinterface/rstudio/) in the [web interface](../../computing/webinterface/index.md). 
