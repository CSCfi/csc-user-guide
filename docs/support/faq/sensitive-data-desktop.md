...
For further information see: [Default programs available on SD Desktop](../../data/sensitive-data/sd_desktop.md#default-programs-available-on-sd-desktop) and [Software customisation](../../data/sensitive-data/sd_desktop.md#sd-software-installer).
