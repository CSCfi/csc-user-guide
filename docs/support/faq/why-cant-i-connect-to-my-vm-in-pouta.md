...
The only solution for this issue is to recreate the instance, this time remember to add a key pair. See the [SSH Key Pair](../../cloud/pouta/tutorials/ssh-key) and the [Creating a virtual machine](../../cloud/pouta/launch-vm-from-web-gui) articles.
