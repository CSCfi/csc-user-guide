...
!!! warning "Preliminary Roihu information"
     Some sections in this tutorial showcase Roihu-specific information about connecting
     to the new system. Roihu is **not yet available for use**, and will only be available
     after 29.6.2026.

     However, you can use the information found in the docs to familiarize yourself with
     aspects of connecting to Roihu, already in advance.
