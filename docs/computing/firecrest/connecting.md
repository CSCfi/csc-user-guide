...
A personal access token can be retrieved from `TODO: MyCSC token interface link`. Personal access tokens generated at MyCSC are valid for 24 hours at a time.
