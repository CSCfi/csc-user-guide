...
#### Writer
 ...
 - When creating a new article, add it also to the mkdocs.yml navigation OR in the index.md file in that folder (in case of FAQs for example). For new software (=apps) pages, add them to by_discipline.md. See also the [FAQ](FAQ.md#how-to-include-my-new-page-in-the-navigation-panel).
